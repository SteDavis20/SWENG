...
class LowestCommonAncestor1Test(unittest.TestCase):
	...
	def testfindLCAVIsAncestor(self):        
		...
		l1 = Node(4)
		m1 = Node(8)
		self.assertEqual(longNarrowTree.root.leftChild, longNarrowTree.findLCA(longNarrowTree.root, l1.data, m1.data))
	...
	def testfindLCAVNotAValidNode(self):
		...
		l1 = Node(11)
		m1 = Node(8)
		self.assertEqual(None, longNarrowTree.findLCA(longNarrowTree.root, l1.data, m1.data))
